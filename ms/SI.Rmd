...
```{r, include=FALSE}
targets::tar_load(sma_sep_plot)
```

![](../figs/sma_sep.png){ width="400" style="display: block; margin: 0 auto" }
...
```{r, include=FALSE}
targets::tar_load(ratio_dm_plot)
```
