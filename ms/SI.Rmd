...
#title: "Maenpuen *et al.* --American Journal of Botany-- Appendix S1"
geometry: margin=1in
link-citations: yes
...
header-includes:
  ...
  - \fancyhead[RE,RO]{Maenpuen \textit{et al}. --American Journal of Botany-- Appendix S1} # add header on right side
 # - \captionsetup[figure]{name=Figure S} #  - \usepackage{lineno}
#  - \linenumbers
output:
  html_document:
    fig_caption: yes
...
![](../figs/S2.jpeg){ width="470" style="display: block; margin: 0 auto" }
...
![](../figs/lma_ld.pdf){ width="600" style="display: block; margin: 0 auto" }
