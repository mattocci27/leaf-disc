...
Specifically, species with greater leaf tissue density (Fig. 1a, $\beta_1$), and larger (Fig. 1a, $\beta_2$) and thicker leaves (Fig. 1a, $\beta_3$) had greater whole-leaf LMA than leaf disc LMA.
Species with lower leaf tissue density (Fig. 1b, $\gamma_1$), larger leaf area (Fig. 1b, $\gamma_2$), and thinner leaves (Fig. 1b, $\gamma_3$) had larger variance in the relationship between the whole-leaf LMA and leaf disc LMA.
