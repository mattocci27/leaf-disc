...
There are not many records that explicitly indicate leaf disc LMA in the TRY database, but leaf disc LMA has been used for ecological studies as well as physiological studies [e.g., @Kraft2008; @Poorter2009a; @Onoda2011; @Serbin2019; @Campany2021].
@Poorter2009a found that leaf disc LMA showed stronger correlations with shade tolerance than whole-leaf LMA, suggesting that lamina traits are more important whole-leaf traits in certain ecological contexts
