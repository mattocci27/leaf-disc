...
Altough a leaf punch of 1.0-cm diameter was used only in the Yakushima dataset in our study, the correlations were also strong for the Yakushima dataset, regardless of leaf tissue density or leaf thickness (Fig. 2ac).
...
The relatively low *R^2^* values in the Yunnan dataset (Appendix S5) compared to the previous study and the Yakushima dataset may suggest not only the effect of distinct veins on variance in LMA [@John2017] or distinct veins with kite-type appearances [@Grubb1986] but also technical difficulty in measuring tiny weight of discs in lower LMA leaves.
