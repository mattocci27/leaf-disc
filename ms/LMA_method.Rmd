...
Actually, LMA was the most often requested leaf trait in the TRY plant data database (2,977 out of 7,330 requests), followed by leaf nitrogen contents per leaf dry mass [1,938 requests, @Kattge2020 [status October 1 2019]].
...
2) a leaf disc excluding all major veins or petioles (645 observations and 403 species) [@Perez-Harguindeguy2013; @Kattge2020 [TRY version 5]].
