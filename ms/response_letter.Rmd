...
Thank you.
We note that a key difference between leaf disc and whole-leaf LMA is that leaf disc LMA focuses on lamina rather than whole-leaf and usages depend on ecological contexts.
...
Thank you.
** this should be somewhere else and not line 57**.
We have cited it in XX.
...
Thank you.
We have added confidence intervals using bootstraps.
