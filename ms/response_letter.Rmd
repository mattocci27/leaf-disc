...
Thank you.
We have updated the line 26 but key the line 51 as "the key trait" because xxx
...
According to the trait hand book (Perez-Harguindeguy 2013), either including or excluding petiole will fine.
As long as we checked the TRY data that we have now, the numbers of LMA records for those two measurements are very similar:
the number of records of LMA (or 1/SLA) including petiole is 57,033, and
the number of records of LMA (or 1/SLA) excluding petiole is 59,103.
(add conclusion).

Thank you.
We now more clearly explain that thick veins are secondary order veins.
We have also added detailed LMA measurement protocol in Fig. SX.
...
We have added detailed LMA measurement protocol in Fig. SX as note above.
