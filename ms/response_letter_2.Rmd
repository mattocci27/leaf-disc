...
"Note that OLS regressions minimize errors of either whole-leaf LMA or leaf disc LMA, and thus those four models are not identical, whereas SMA regressions are not appropriate for predictions (Warton et al., 2006)" (Line 320-322)

> Line 315 Typo

Thank you again for pointing this error out.
We have corrected it (Line 318).
...
Confirmed:
We have added a new line for the acknowledgements (line 378).
