...
targets::tar_load("fit_sp_21_summary_model2")
targets::tar_load("fit_sp_3_summary_model")
targets::tar_load("fit_sp_31_summary_model")
targets::tar_load("fit_sp_32_summary_model")
...
targets::tar_load("fit_sp_21_diagnostics_model2")
targets::tar_load("fit_sp_3_diagnostics_model")
targets::tar_load("fit_sp_31_diagnostics_model")
targets::tar_load("fit_sp_32_diagnostics_model")
...
fit_sp_21_summary_model2 |> filter(rhat > 1.1)
fit_sp_3_summary_model |> filter(rhat > 1.1)
fit_sp_31_summary_model |> filter(rhat > 1.1)
fit_sp_32_summary_model |> filter(rhat > 1.1)
...
div_check(fit_sp_21_diagnostics_model2)
div_check(fit_sp_3_diagnostics_model)
div_check(fit_sp_31_diagnostics_model)
div_check(fit_sp_32_diagnostics_model)
...
loo::loo_compare(loo_model[[1]], loo_model[[2]], loo_model[[3]],
  loo_model[[4]], loo_model[[5]], loo_model[[6]], loo_model[[7]], loo_model[[8]])
```
