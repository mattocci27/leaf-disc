...
sp_mean |>
  group_by(ldlalt_gr) |>
  summarise(
          ld_mean = mean(ld_disc) |> round(3),
          la_mean = mean(la) |> round(1),
          lt_mean = mean(lt) |> round(3)) |>
...
targets::tar_load(fit_sp_ld2_summary_model)
...
targets::tar_load(fit_sp_ld2_diagnostics_model)
...
fit_sp_ld2_summary_model |> filter(rhat > 1.1)
...
div_check(fit_sp_ld2_diagnostics_model)
